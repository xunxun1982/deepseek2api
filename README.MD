...
支持配置多个代理服务器，实现请求负载均衡和 IP 轮换。代理池支持以下特性：
...
详细说明请参考 [PROXY_POOL_README.md](PROXY_POOL_README.md)
...
**Dockerfile 版本说明**：详见 [DOCKERFILE_VERSIONS.md](DOCKERFILE_VERSIONS.md)
